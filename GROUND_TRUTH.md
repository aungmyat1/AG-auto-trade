...
1. Validation core (plain Python, zero engine dependency) ← CURRENT
2. Platform (risk, regime, monitoring, infrastructure)
3. Alpha modules (A1, A2, A3 to common generate_signal() interface)
